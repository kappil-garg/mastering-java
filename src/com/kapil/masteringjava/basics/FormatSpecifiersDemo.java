 ...
 * Format specifiers provide precise control over how values are formatted and displayed in output.
 * The same format specifiers apply to both printf() and format() methods.
 *
 * @author Kapil Garg
 */
